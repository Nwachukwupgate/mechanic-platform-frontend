export default function ForMechanics() {
  return (
    <div className="max-w-4xl mx-auto py-12 px-4">
      <h1 className="text-4xl font-bold mb-8">For Mechanics</h1>
      <div className="space-y-6 text-gray-700">
        <p className="text-lg">
          Join our platform and grow your mechanic business. Connect with customers who need your expertise.
        </p>
        <div>
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Track your job history and earnings</li>
          </ul>
        </div>
      </div>
    </div>
